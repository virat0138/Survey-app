...
public class English_Sector_Rural3 extends AppCompatActivity {
    CheckBox c[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english__sector__rural3);

        Intent in = getIntent();
        phone = in.getStringExtra("id");

        confirm = findViewById(R.id.e4_confirm_3);
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                enterData();
                Intent i = new Intent(getApplicationContext(), English_Sector_Rural4.class);
                i.putExtra("id",phone);
                startActivity(i);
            }
        });
        ...
        for (int k = start; k < end; k++) {
            if (c[k].isChecked()) {
                ...
                for (int i = 1; i <= put.size(); i++) {
                    ...
                    new onlineTableRow(English_Sector_Rural3.this,phone, addRow[0], addRow[1], addRow[2], addRow[3], addRow[4],addRow[5], addRow[6], addRow[7]).execute("");
