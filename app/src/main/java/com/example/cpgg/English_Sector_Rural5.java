...
public class English_Sector_Rural5 extends AppCompatActivity {
    CheckBox c[];
    HorizontalScrollView h[];
    int totalCheckBox;
    public final int start = 11;
    public final int end = 14;
    String phone;
    Button confirm;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english__sector__rural5);

        Intent in = getIntent();
        phone = in.getStringExtra("id");
        confirm = findViewById(R.id.e4_confirm_5);
        ...
        for (int k = start; k < end; k++) {
            if (c[k].isChecked()) {
                ...
                for (int i = 1; i <= put.size(); i++) {
                    ...
                    new onlineTableRow(English_Sector_Rural5.this,phone, addRow[0], addRow[1], addRow[2], addRow[3], addRow[4],addRow[5], addRow[6], addRow[7]).execute("");
